...
const translations = {
    id: {
        ...
        'click_to_upload': 'Klik untuk pilih gambar struk',
        'max_size': 'JPG, PNG, WEBP · Maks 10 MB',
    ...
    en: {
        ...
        'click_to_upload': 'Click to select receipt image',
        'max_size': 'JPG, PNG, WEBP · Max 10 MB',
